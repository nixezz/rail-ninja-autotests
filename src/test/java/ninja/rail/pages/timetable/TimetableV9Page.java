...
public class TimetableV9Page extends BaseSeleniumPage implements TimetablePage {
    private static final Logger LOGGER = LoggerFactory.getLogger(TimetableV9Page.class);
    private final WebDriverWait wait;

    public TimetableV9Page(WebDriver driver) {
        super(driver);
        this.pagePath = "";
    ...
    public TimetableV9Page selectFirstTrain() {
        LOGGER.info("Selecting the first train in the list");
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(@class, 'ffjWTj')]")));
        WebElement firstTrain = driver.findElement(By.xpath("/html/body/div[1]/div/main/div[2]/div[3]/div[1]"));
        firstTrain.click();
        return this;
    }

    @Override
    @Step("Нажатие на кнопку Continue в окне выбора поезда (Flexible)")
    public PassengersPage clickButtonToPassengerInfo(){
        ...
        try {
            ...
            WebElement button = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("//*[@id=\"__next\"]/div/main/div[2]/div[3]/div[1]/div/div/div[2]/div[2]/button")
            ));
            button.click();
